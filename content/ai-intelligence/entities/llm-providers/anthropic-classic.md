...
- Originator of [[entities/protocols/mcp-classic|mcp]] (Model Context Protocol)
...
- **Claude Haiku**: Fast, cost-efficient variant for high-volume orchestration, classification, and simple tool-calling loops. Ideal for [[concepts/agent-patterns/routing-classic|routing]] decisions and high-throughput [[concepts/agent-patterns/prompt-chaining-classic|prompt-chaining]] steps.
...
- **Claude Opus**: Strongest reasoning variant for complex planning, deep code analysis, and tasks requiring extended chain-of-thought. Suitable for [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] and [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]] architectures.
...
- [[entities/protocols/mcp-classic|mcp]] — Anthropic introduced the protocol and continues to steward its development
- [[coding-agents]] — Anthropic is a major vendor through Claude Code and the Claude API
- [[concepts/agent-patterns/function-calling-classic|function-calling]] — Claude models compete heavily on tool-use quality and structured output reliability
...
[[entities/protocols/mcp-classic|mcp]], [[coding-agents]], [[concepts/agent-patterns/function-calling-classic|function-calling]], [[openai-agents-sdk]], [[tool-use-pattern]], [[langchain]], [[langgraph]]
