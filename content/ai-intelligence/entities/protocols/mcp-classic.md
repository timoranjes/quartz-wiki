...
MCP sits at the intersection of agent frameworks, developer environments, and enterprise tool layers. It is closely related to [[concepts/agent-patterns/function-calling-classic|function-calling]], but works at a broader systems level: [[concepts/agent-patterns/function-calling-classic|function-calling]] is the model-side invocation pattern, while MCP is a protocol for exposing capabilities consistently across tools and hosts.
...
[[anthropic]], [[concepts/agent-patterns/function-calling-classic|function-calling]], [[tool-use-pattern]], [[openai-agents-sdk]], [[langchain]], [[coding-agents]], [[concepts/agent-patterns/react-pattern-classic|react-pattern]]
