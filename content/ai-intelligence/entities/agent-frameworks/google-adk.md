...
4. **Multi-agent routing** — Supports sub-agent delegation and routing between
   specialized agents, enabling [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]] patterns
...
[[tool-use-pattern]], [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]], [[concepts/agent-patterns/routing-classic|routing]], [[concepts/agent-patterns/function-calling-classic|function-calling]],
[[concepts/agent-patterns/react-pattern-classic|react-pattern]]
