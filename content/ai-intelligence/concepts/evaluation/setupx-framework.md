...
The setup problem is particularly acute in [[concepts/evaluation/swe-bench-classic|swe-bench]]-style evaluations,
...
- **Your agents must configure unfamiliar codebases** before running tests,
  building, or deploying. This is common for [[concepts/evaluation/swe-bench-classic|swe-bench]]-style tasks.
...
- [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]] is more useful when paired with durable
...
- [[concepts/evaluation/swe-bench-classic|swe-bench]]-style evaluation is incomplete without setup and execution
  realism. An agent that cannot install the project cannot fix its bugs.

- [[concepts/agent-patterns/function-calling-classic|function-calling]] alone is not enough for robust coding agents unless
...
- It embodies a specialized [[concepts/agent-patterns/react-pattern-classic|react-pattern]] loop where the reasoning
...
- It complements [[concepts/agent-patterns/evaluation-classic|evaluation]] by providing a focused benchmark for a
  narrow but critical capability.

- It demonstrates how [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]] can split setup and coding
  into distinct roles.

- It connects to [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] because repair attempts must be
  planned and sequenced logically.

- It relates to [[concepts/agent-patterns/routing-classic|routing]] in that a smart agent might route a setup
...
[[coding-agents]], [[concepts/evaluation/swe-bench-classic|swe-bench]], [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]],
[[tool-use-pattern]], [[concepts/agent-patterns/react-pattern-classic|react-pattern]], [[concepts/agent-patterns/evaluation-classic|evaluation]],
[[concepts/agent-patterns/function-calling-classic|function-calling]], [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]], [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]],
[[concepts/agent-patterns/routing-classic|routing]]
