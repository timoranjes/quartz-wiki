...
- It embodies a specialized [[concepts/agent-patterns/react-pattern-classic|react-pattern]] loop where reasoning
...
- It extends [[concepts/agent-patterns/routing-classic|routing]] by requiring the agent to route between "act
  directly" and "ask for clarification" based on ambiguity detection.

- It complements [[concepts/agent-patterns/evaluation-classic|evaluation]] by providing a focused benchmark for
  personalization capability that other benchmarks ignore.

- It demonstrates how [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] can incorporate user
  preference as a constraint in task decomposition.

- It relates to [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]] where one worker handles
...
[[tool-use-pattern]], [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]], [[coding-agents]],
[[concepts/evaluation/swe-bench-classic|swe-bench]], [[concepts/agent-patterns/evaluation-classic|evaluation]], [[concepts/agent-patterns/react-pattern-classic|react-pattern]], [[concepts/agent-patterns/routing-classic|routing]],
[[concepts/agent-patterns/planning-pattern-classic|planning-pattern]], [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]]
