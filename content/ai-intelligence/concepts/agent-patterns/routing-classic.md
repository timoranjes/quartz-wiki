...
- [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] — Planning determines the sequence of steps within a chosen
...
- [[concepts/agent-patterns/react-pattern-classic|react-pattern]] — ReAct can implement routing as one of its action steps,
...
[[concepts/agent-patterns/planning-pattern-classic|planning-pattern]], [[tool-use-pattern]], [[concepts/agent-patterns/react-pattern-classic|react-pattern]], orchestrator-workers
