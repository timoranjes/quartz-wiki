...
- [[concepts/agent-patterns/react-pattern-classic|react-pattern]] — Reflection can be embedded within the ReAct loop to critique
  reasoning traces before committing to an action
- [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] — Plans benefit greatly from reflection; reviewing a plan
