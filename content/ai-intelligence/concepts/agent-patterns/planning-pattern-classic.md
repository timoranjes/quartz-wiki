...
sub-agent or solved with another pattern like [[concepts/agent-patterns/react-pattern-classic|react-pattern]].
...
- [[concepts/agent-patterns/react-pattern-classic|react-pattern]] — ReAct interleaves thinking and acting; planning separates
  them into distinct phases. ReAct can be viewed as implicit planning.
- [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]] — Reflection can be applied to review a plan before
...
- [[concepts/agent-patterns/routing-classic|routing]] — Routing decides which path or agent handles a task; planning
