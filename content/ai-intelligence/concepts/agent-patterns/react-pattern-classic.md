...
- **[[concepts/agent-patterns/prompt-chaining-classic|prompt-chaining]]**: Prompt chaining composes fixed sequences of
...
- **Tasks with a known, fixed sequence** where [[concepts/agent-patterns/prompt-chaining-classic|prompt-chaining]] or
...
- [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] extends ReAct by adding explicit multi-step
  planning before the loop begins, then replanning when conditions
  change.

- [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]] can be inserted into the ReAct loop as an
...
- [[concepts/agent-patterns/function-calling-classic|function-calling]] provides the structured interface through which
  ReAct agents invoke tools.

- [[concepts/agent-patterns/routing-classic|routing]] can precede a ReAct loop by determining which set of
  tools and which reasoning strategy the agent should use.

- [[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]] can decompose a complex task into subtasks,
  each handled by a ReAct agent with specialized tools.

- [[concepts/agent-patterns/evaluation-classic|evaluation]] benefits from ReAct's transparent trace, which makes
...
[[tool-use-pattern]], [[concepts/agent-patterns/function-calling-classic|function-calling]], [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]],
[[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]], [[concepts/agent-patterns/prompt-chaining-classic|prompt-chaining]], [[concepts/agent-patterns/routing-classic|routing]],
[[concepts/agent-patterns/orchestrator-workers-classic|orchestrator-workers]], [[concepts/agent-patterns/evaluation-classic|evaluation]]
