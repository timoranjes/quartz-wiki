...
- [[concepts/agent-patterns/routing-classic|routing]] — The orchestrator includes a routing layer to decide which worker
  handles each subtask
- [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]] — Task decomposition is a form of planning; the orchestrator
...
[[concepts/agent-patterns/routing-classic|routing]], [[concepts/agent-patterns/planning-pattern-classic|planning-pattern]], [[single-vs-multi-agent]], [[coding-agents]],
[[crewai]], [[langgraph]]
