...
Evaluation is distinct from [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]] — reflection is self-directed
...
### Benchmark Suites
- **[[concepts/evaluation/swe-bench-classic|swe-bench]]** — Real GitHub issues, pass/fail based on test execution
...
- [[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]] — Self-directed quality improvement during execution; evaluation
  is externally administered assessment
- [[concepts/evaluation/swe-bench-classic|swe-bench]] — A specific benchmark suite for code-related agent tasks
...
[[concepts/agent-patterns/reflection-pattern-classic|reflection-pattern]], [[concepts/evaluation/swe-bench-classic|swe-bench]], [[coding-agents]], [[tool-use-pattern]],
[[concepts/evaluation/persona2web-benchmark|persona2web]]
